const Pricing = () => {
    const pricingCards = [
        ...
        {
            title: "Pro Package",
            description: "Advanced healthcare services for families.",
            fee: 20,
            features: [
    ...
    return (
        <section id="pricing">
            <div className="container pricing">
                ...
                <div className="pricing__card-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">

                    {pricingCards.map((pricingCard, index) => (
                        <article key={index} className="pricing__card bg-white rounded-md rounded-t-none shadow-md p-5 relative border-t-4 border-[var(--color-green)]">
