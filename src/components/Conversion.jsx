const Conversion = () => {
    return (
        <section id="conversion" className="relative">
            ...
            <div className="absolute inset-0 -z-10 w-full h-full bg-cover bg-center brightness-50" style={{ backgroundImage: "url('/src/assets/conversion/conversion-image-1.jpg')" }}></div>
