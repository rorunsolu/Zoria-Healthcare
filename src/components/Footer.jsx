    ...
    <footer className="bg-green py-[1rem] px-[1rem]">
      <div className="footer grid grid-cols-1 lg:grid-cols-6 gap-[1.5rem]">
        <div className="footer__company col-span-2">
          ...
          <p className="footer__company-subtitle body-1 my-4 text-white">
            Committed to providing exceptional healthcare services to support
          ...
          <div className="footer__socials flex gap-[1rem]">
            {socialLinks.map((link, index) => (
              <a
                key={index}
                className="footer__socials-link text-white hover:text-yellow-300"
                href={link.href}
                target="_blank"
              >
          ...
          <p className="footer__company-copyright text-white mt-[1rem]">
        ...
        {groupedLinks.map((group, index) => (
          <div key={index} className={"footer__group col-span-2"}>
            <h4 className="footer__group-title text-white font-bold mt-[0.5rem] mb-4">
              {group.title}
            </h4>
            <ul className="footer__group-list space-y-1">
              {group.links.map((link, index) => (
                <li key={index}>
                  <a
                    className="footer__group-link text-white hover:text-yellow-300"
                    href="#"
                  >
                    {link}
                  </a>
